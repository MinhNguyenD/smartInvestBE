...
resource "aws_secretsmanager_secret_version" "smartinvest-user-rds-secret-version" {
  secret_id     = aws_secretsmanager_secret.smartinvest-user-rds-secret.id
...
resource "aws_secretsmanager_secret_version" "smartinvest-portfolio-rds-secret-version" {
  secret_id     = aws_secretsmanager_secret.smartinvest-portfolio-rds-secret.id
...
resource "aws_secretsmanager_secret_version" "smartinvest-user-jwt-secret-version" {
  secret_id     = aws_secretsmanager_secret.smartinvest-user-jwt-secret.id
...
resource "aws_secretsmanager_secret_version" "smartinvest-portfolio-jwt-secret-version" {
  secret_id     = aws_secretsmanager_secret.smartinvest-portfolio-jwt-secret.id
  secret_string = "sadsandiusahdsadasnduahe3qansdnas12312312NdjAbdshasdadasdsajdjasdasudhausd"
}

resource "aws_secretsmanager_secret_version" "smartinvest-portfolio-marketdata-secret-version" {
  secret_id     = aws_secretsmanager_secret.smartinvest-portfolio-marketdata-secret.id
...
resource "aws_secretsmanager_secret_version" "smartinvest-portfolio-OpenAI-secret-version" {
  secret_id     = aws_secretsmanager_secret.smartinvest-portfolio-OpenAI-secret.id
